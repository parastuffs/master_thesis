...
OpenSSL is not the only cryptographic library available; PolarSSL and GnuTLS could also be viable solutions.
%TODO see if they can use cryptodev, that would be perfect.
