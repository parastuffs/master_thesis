...
\lstdefinelanguage{diff}{
  morecomment=[f][\color{NavyBlue}]{@@},     % group identifier
...
\lstdefinelanguage{config}{
  morecomment=[f][\color{MidnightBlue}]\#,%comment
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%http://tex.stackexchange.com/questions/2393/testing-for-current-page
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{ifthen}
\newcounter{cPage}
...
% \setcounter{tocdepth}{3}% Add subsubsection to the table of content.
\setcounter{tocdepth}{2}% Add subsection to the table of content.
...
\oldCaption[#1]{{\small\bfseries #1:} #2}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NEW STYLES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Titre
\newcommand{\titleA}{\fontTitle{Implementation of High-Level}} % Titre identique au titre remis au secrétariat
\newcommand{\titleB}{\fontTitle{Cryptographic Protocols}} % (dans la langue de rédaction a priori)
\newcommand{\titleC}{\fontTitle{using a SoC Platform}} % (dans la langue de rédaction a priori)
% Sous-titre
...
\newcommand{\diplomaB}{\fontText{d'Ingénieur Civil en informatique à finalité Software and Critical Systems Design}}
