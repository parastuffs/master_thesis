...
\begin{axis}[
        ...
        ybar=10pt,%space between the bars
        bar width=8pt,
...
% \addplot[style={LimeGreen,fill=LimeGreen,mark=none}, bar shift=.1cm]
\addplot[style={LimeGreen,fill=LimeGreen,mark=none}]
    coordinates {
        (oot, 0)
        (none:none, 25)
        (aes256cbc:none, 82)
...
\addplot[style={RedOrange,fill=RedOrange,mark=none}]
    coordinates {
        (oot, 0)
        (none:none, 25)
        (aes256cbc:none, 82)
...
\addplot[style={ForestGreen,fill=ForestGreen,mark=none}]
    coordinates {
        ...
        (none:none, 500)
        (aes256cbc:none, 400)
        (aes256cbc:sha256, 300)
    };
    \label{}

\addplot[style={BrickRed,fill=BrickRed,mark=none}]
    coordinates {
        (oot, 0)
        (none:none, 500)
        (aes256cbc:none, 400)
